...
> ✅ 2026-06-17 晚现状：正式域名 `bokejianji.cn` 已可用，ICP备案号、页脚备案号、HTTPS、服务器稳定性、P0 导出/删除修复、H1 鉴权默认安全修复均已上线。现在别按 6/14 旧清单判断优先级。
...
| B | 浏览器侧操作卡顿 | 服务器侧导出卡死已根治；剪辑页点删除/气口缩短的前端卡顿只缓解一部分，后续再做深优化。 |
