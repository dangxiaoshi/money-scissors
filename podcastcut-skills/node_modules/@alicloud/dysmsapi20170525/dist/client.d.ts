...
export default class Client extends OpenApi {
     ...
     */
    createDigitalSignOrderWithOptions(tmpReq: $_model.CreateDigitalSignOrderRequest, runtime: $dara.RuntimeOptions): Promise<$_model.CreateDigitalSignOrderResponse>;
    /**
     * 数字短信签名操作订单
     *
     ...
     * @returns CreateDigitalSignOrderResponse
     */
    createDigitalSignOrder(request: $_model.CreateDigitalSignOrderRequest): Promise<$_model.CreateDigitalSignOrderResponse>;
    /**
     * 创建数字短信模板
     *
     ...
     */
    createDigitalSmsTemplateWithOptions(request: $_model.CreateDigitalSmsTemplateRequest, runtime: $dara.RuntimeOptions): Promise<$_model.CreateDigitalSmsTemplateResponse>;
    /**
     * 创建数字短信模板
     *
     * @param request - CreateDigitalSmsTemplateRequest
     * @returns CreateDigitalSmsTemplateResponse
     */
    createDigitalSmsTemplate(request: $_model.CreateDigitalSmsTemplateRequest): Promise<$_model.CreateDigitalSmsTemplateResponse>;
    /**
     ...
     */
    queryDigitalSignByNameWithOptions(request: $_model.QueryDigitalSignByNameRequest, runtime: $dara.RuntimeOptions): Promise<$_model.QueryDigitalSignByNameResponse>;
    /**
     * 获取数字短信签名通过签名name
     *
     * @param request - QueryDigitalSignByNameRequest
     * @returns QueryDigitalSignByNameResponse
     */
    queryDigitalSignByName(request: $_model.QueryDigitalSignByNameRequest): Promise<$_model.QueryDigitalSignByNameResponse>;
    /**
     * 查询验证码签名
     *
