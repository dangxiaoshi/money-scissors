...
class Client extends openapi_core_1.default {
     ...
     */
    async createDigitalSignOrderWithOptions(tmpReq, runtime) {
        tmpReq.validate();
        let request = new $_model.CreateDigitalSignOrderShrinkRequest({});
        openapi_core_2.OpenApiUtil.convert(tmpReq, request);
        if (!$dara.isNull(tmpReq.orderContext)) {
            request.orderContextShrink = openapi_core_2.OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.orderContext, "OrderContext", "json");
        }
        let query = {};
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.CreateDigitalSignOrderResponse({}));
    }
    /**
     * 数字短信签名操作订单
     *
     ...
     * @returns CreateDigitalSignOrderResponse
     */
    async createDigitalSignOrder(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async createDigitalSmsTemplateWithOptions(request, runtime) {
        request.validate();
        let query = {};
        if (!$dara.isNull(request.ownerId)) {
            query["OwnerId"] = request.ownerId;
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.CreateDigitalSmsTemplateResponse({}));
    }
    /**
     * 创建数字短信模板
     *
     ...
     * @returns CreateDigitalSmsTemplateResponse
     */
    async createDigitalSmsTemplate(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async queryDigitalSignByNameWithOptions(request, runtime) {
        request.validate();
        let query = {};
        if (!$dara.isNull(request.ownerId)) {
            query["OwnerId"] = request.ownerId;
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.QueryDigitalSignByNameResponse({}));
    }
    /**
     * 获取数字短信签名通过签名name
     *
     ...
     * @returns QueryDigitalSignByNameResponse
     */
    async queryDigitalSignByName(request) {
        let runtime = new $dara.RuntimeOptions({});
